...
class BulletinAnulle(models.TransientModel):
    _name = 'gescoth.bulletin.annuel_5'
    ...
    def imprimer_bulletin_annuel(self):
        ...
        for el in eleve_ids:
            ...
            for note in el_note_ids:
                ...
                vals_note = {
                    ...
                    'total': note.total_5,
                    'moyenne_annuelle_5': note.moyenne_annuel_5,
                    'rang':note.rang_5,
                    'appreciation':note.appreciation_5,
                ...
                if note.coeficient_id.matiere.type_matiere == 'sport' and not el.Apt_sport:
                    ...
                    if not note.coeficient_id.est_facultative or not note.is_not_compose:
                        coef += note.coeficient_id.coef
                    total += (note.moyenne_annuel_5  * note.coeficient_id.coef)
        ...
        return self.env.ref('gescoth.bulletin_par_sequence_annuel_report_5_view').report_action(self, data=data)
